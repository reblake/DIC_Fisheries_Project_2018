...
val_sp_plot <- ggplot(data=all_time_max, aes(x=Year, y=Revenue)) +
               ...
               ylab("Revenue by Species group") + xlab("") +
...
```{r, fig.cap="Fisheries revenue and revenue per pound for Pacific states from 1990 - 2016", fig.width = 9, fig.height = 12, fig.align="center", echo=FALSE}
